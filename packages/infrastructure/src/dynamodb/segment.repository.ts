...
export class DynamoDBSegmentRepository implements SegmentRepository {
  ...
  private toEntity(item: Record<string, unknown>): Segment {
    return Segment.create(item['id'] as string, {
      ...
      averageGrade: item['averageGrade'] as number | undefined,
      maximumGrade: item['maximumGrade'] as number | undefined,
      elevationHigh: item['elevationHigh'] as number | undefined,
      elevationLow: item['elevationLow'] as number | undefined,
      climbCategory: item['climbCategory'] as number | undefined,
      private: item['private'] as boolean | undefined,
      hazardous: item['hazardous'] as boolean | undefined,
      starCount: item['starCount'] as number | undefined,
      athleteCount: item['athleteCount'] as number | undefined,
      effortCount: item['effortCount'] as number | undefined,
      rawStravaMetadata: item['rawStravaMetadata'] as Record<string, unknown> | undefined,
